public class SubstringExample {
    public static void main(String[] args) {
        ...
        String message = "La Euro 2024, România a trecut doar pentru a doua oară în istoria sa " +
                "fotbalistică de faza grupelor la un turneu final de Campionat European. " +
                "Acum, în duelul din optimi cu Olanda, trebuie să bifăm o a doua performanță istorică, " +
                "dacă vrem să prindem sferturile.";
